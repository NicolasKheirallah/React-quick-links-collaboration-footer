            ...
            <BulkOperationsSection
              ...
              onResetAllSettings={() => {
                if (confirm('Are you sure you want to reset all settings? This cannot be undone.')) {
                  ...
                  onAdminSettingChange('resetToDefaults', true);
                  onStatusUpdate('All settings have been reset to defaults');
                }
              }}
              onValidateAllLinks={async () => {
                onStatusUpdate('Starting link validation...');
                // The validation logic is already implemented in BulkOperationsSection
                // This callback just provides a status update entry point
              }}
              isLoading={isLoading}
            />
          </div>
